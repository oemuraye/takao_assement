...
var showUserData = function () { return __awaiter(_this, void 0, void 0, function () {
    var usersInfo, mainContainer, userInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!mainContainer)
                    return [2 /*return*/];
                usersInfo.map(function (user) {
                    var info = "\n          <div class=\"flip-card\">\n            <div class=\"flip-card-content\">\n                <div class=\"flip-card-front\">\n                    <img src=".concat(user.id, " alt=\"user-info\">\n                    <span>\n                        <h3>").concat(user.title, " </h3>\n                    </span>\n                </div>\n                <div class=\"flip-card-back\">\n                    <h3>More Info</h3>\n                    <ul>\n                        <li><h4>Address: </h4> <p>dfbhbnkndf</p></li>\n                        <li><h4>Address: </h4> <p>dfbhbnkndf</p></li>\n                        <li><h4>Address: </h4> <p>dfbhbnkndf</p></li>\n                        <li><h4>Address: </h4> <p>dfbhbnkndf</p></li>\n                        <li><h4>Address: </h4> <p>dfbhbnkndf</p></li>\n                    </ul>\n                </div>\n            </div>\n        </div>\n        ");
                    userInfo += info;
                });
